...
COPY services/audiveris-provider/app.py /app/app.py
ENV PATH=/opt/venv/bin:$PATH AUDIVERIS_BIN=/usr/local/bin/audiveris AUDIVERIS_VERSION=${AUDIVERIS_VERSION} HM_AUDIVERIS_DATA_DIR=/data JAVA_TOOL_OPTIONS="-Xmx384m -Djava.awt.headless=true" HOME=/data/home PORT=8000
