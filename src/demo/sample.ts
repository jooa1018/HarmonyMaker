...
[V:S] C D E G | G F E D | E F G A | G E D C | F G A G | E D C4 |
[V:A] G A C E | E D C B, | C D E F | E C B, C | C E F E | C B, C4 |
[V:T] C, F, A, C | C G, A, G, | A, F, C F, | C A, G, C | A, C F, C | G, G, C,4 |`;
